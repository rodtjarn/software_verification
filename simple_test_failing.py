"""
Simple tests - with one intentional failure to show verification vs coverage
"""
...
def test_intentional_failure():
    """THIS WILL FAIL - to demonstrate coverage vs verification"""
    assert reverse_string("hello") == "wrong"  # Intentionally wrong!
